...
My First ETL project - At least thats what I thought! Realized that I have been doing ETL/ELT everyday in my current role as a data analyst in the healthcare domain:
    ...
    - **Extract**: 
        - Making conncetion to the Data repository
        - Combine multiple tables from hundreds of views 
    ...
    - **Transform**: Here we add various formats to the master table 
        ...
        e.g Patient_First_Name to "Patient First Name"
        - Create features in the tables using CASE statments to categorize the claims into 
        approved or denied.
